module.exports = {
	...
	scripts: {
		...
		'@nstudio': {
			...
			'nativescript-branch': {
				build: {
					script: 'nx run nativescript-branch:build.all',
					description: '@nstudio/nativescript-branch: Build',
				},
			},
			...
			// @nstudio/nativescript-contentful
			'nativescript-contentful': {
				build: {
					script: 'nx run nativescript-contentful:build.all',
					description: '@nstudio/nativescript-contentful: Build',
				},
			},
			'build-all': {
		...
		focus: {
			...
			'nativescript-branch': {
				script: 'nx run nativescript-branch:focus',
				description: 'Focus on @nstudio/nativescript-branch',
			},
			'nativescript-auth0': {
			...
			'nativescript-contentful': {
				script: 'nx run nativescript-contentful:focus',
				description: 'Focus on @nstudio/nativescript-contentful',
			},
			reset: {
