...
module.exports = {
	...
	scripts: {
		...
		'@nstudio': {
			...
			'nativescript-waveform': {
				build: {
					script: 'nx run nativescript-waveform:build.all',
					description: '@nstudio/nativescript-waveform: Build',
				},
			},
			'build-all': {
		...
		focus: {
			...
			'nativescript-waveform': {
				script: 'nx run nativescript-waveform:focus',
				description: 'Focus on @nstudio/nativescript-waveform',
			},
			reset: {
