...
export class DemoSharedNativescriptFancyalert extends DemoSharedBase {
	constructor() {
		super();
		if (isIOS) {
	...
	public showCustomImage() {
		TNSFancyAlert.showCustomImage('nativescript.png', '#2B33FF', 'NativeScript', `Using your own images is sure nice.`, 'Yes!');
	}
