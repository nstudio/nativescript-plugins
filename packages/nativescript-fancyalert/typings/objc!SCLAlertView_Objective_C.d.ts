...
declare class SCLAlertView extends UIViewController {
	...
	addButtonTargetSelector(title: string, target: any, selector: string): SCLButton;

	addButtonValidationBlockActionBlock(title: string, validationBlock: () => boolean, action: () => void): SCLButton;
	...
	alertDismissAnimationIsCompleted(dismissAnimationCompletionBlock: () => void): void;
	...
	setButtonsTextFontFamilyWithSize(buttonsFontFamily: string, size: number): void;

	setTitleFontFamilyWithSize(titleFontFamily: string, size: number): void;

	showCustomColorTitleSubTitleCloseButtonTitleDuration(image: UIImage, color: UIColor, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showCustomImageColorTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, image: UIImage, color: UIColor, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showEditSubTitleCloseButtonTitleDuration(title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showEditTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showErrorSubTitleCloseButtonTitleDuration(title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showErrorTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showInfoSubTitleCloseButtonTitleDuration(title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showInfoTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showNoticeSubTitleCloseButtonTitleDuration(title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showNoticeTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showQuestionSubTitleCloseButtonTitleDuration(title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showQuestionTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showSuccessSubTitleCloseButtonTitleDuration(title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showSuccessTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showTitleSubTitleStyleCloseButtonTitleDuration(title: string, subTitle: string, style: SCLAlertViewStyle, closeButtonTitle: string, duration: number): void;

	showTitleTitleSubTitleStyleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, style: SCLAlertViewStyle, closeButtonTitle: string, duration: number): void;

	showWaitingSubTitleCloseButtonTitleDuration(title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showWaitingTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showWarningSubTitleCloseButtonTitleDuration(title: string, subTitle: string, closeButtonTitle: string, duration: number): void;

	showWarningTitleSubTitleCloseButtonTitleDuration(vc: UIViewController, title: string, subTitle: string, closeButtonTitle: string, duration: number): void;
}
...
declare class SCLAlertViewBuilder extends SCLAlertViewBuilder__WithFluent {
	...
	addButtonWithValidationBlock: (p1: string, p2: () => boolean, p3: () => void) => SCLAlertViewBuilder;
	...
	addTextFieldWithBuilder: (p1: SCLALertViewTextFieldBuilder) => SCLAlertViewBuilder;
	...
	attributedFormatBlock: (p1: (p1: string) => NSAttributedString) => SCLAlertViewBuilder;
	...
	completeButtonFormatBlock: (p1: () => NSDictionary<any, any>) => SCLAlertViewBuilder;
...
declare class SCLAlertViewBuilder__WithFluent extends NSObject implements SCLItemsBuilder__Protocol__Fluent {
...
declare class SCLAlertViewShowBuilder extends SCLAlertViewBuilder__WithFluent {
	...
	showAlertViewOnViewController(alertView: SCLAlertView, controller: UIViewController): void;
}
...
declare class SCLButton extends UIButton {
	...
	static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): SCLButton; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): SCLButton; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): SCLButton; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): SCLButton; // inherited from UIAppearance
	...
	adjustWidthWithWindowWidthNumberOfButtons(windowWidth: number, numberOfButtons: number): void;
...
declare class SCLSwitchView extends UIView {
	...
	static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): SCLSwitchView; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): SCLSwitchView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): SCLSwitchView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): SCLSwitchView; // inherited from UIAppearance
...
declare class SCLTextView extends UITextField {
	...
	static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): SCLTextView; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): SCLTextView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): SCLTextView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): SCLTextView; // inherited from UIAppearance
...
declare class SCLTimerDisplay extends UIView {
	...
	static appearanceForTraitCollection(trait: UITraitCollection): SCLTimerDisplay; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): SCLTimerDisplay; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): SCLTimerDisplay; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): SCLTimerDisplay; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): SCLTimerDisplay; // inherited from UIAppearance
	...
	initWithOriginRadiusLineWidth(origin: CGPoint, r: number, width: number): this;
