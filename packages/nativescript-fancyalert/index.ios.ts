...
export class TNSFancyAlert {
	...
	public static showSuccess(title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number, buttons?: Array<TNSFancyAlertButton>): Promise<void> {
	...
	public static showError(title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number, buttons?: Array<TNSFancyAlertButton>): Promise<void> {
		return new Promise((resolve, reject) => {
	...
	public static showNotice(title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number, buttons?: Array<TNSFancyAlertButton>): Promise<void> {
		return new Promise((resolve, reject) => {
	...
	public static showWarning(title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number, buttons?: Array<TNSFancyAlertButton>): Promise<void> {
		return new Promise((resolve, reject) => {
	...
	public static showInfo(title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number, buttons?: Array<TNSFancyAlertButton>): Promise<void> {
		return new Promise((resolve, reject) => {
	...
	public static showEdit(title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number, buttons?: Array<TNSFancyAlertButton>): Promise<void> {
		return new Promise((resolve, reject) => {
	...
	public static showWaiting(title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number): Promise<void> {
		return new Promise((resolve, reject) => {
	...
	public static showQuestion(title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number, buttons?: Array<TNSFancyAlertButton>): Promise<void> {
		return new Promise((resolve, reject) => {
	...
	public static showCustomTextAttributes(attributionBlock: (p1: string) => NSAttributedString, button: TNSFancyAlertButton, image: any, color: string, title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number): Promise<void> {
		return new Promise((resolve, reject) => {
			let alert = TNSFancyAlert.createAlert(width);
			TNSFancyAlert.applyTextDisplayOptions(alert);
	...
	public static showTextField(placeholder: string, initialValue: string, button: TNSFancyAlertButton, image: any, color: string, title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number): Promise<void> {
		return new Promise((resolve, reject) => {
			let alert = TNSFancyAlert.createAlert(width);
			TNSFancyAlert.applyTextDisplayOptions(alert);
	...
	public static showSwitch(switchLabel: string, switchColor: string, button: TNSFancyAlertButton, image: any, color: string, title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number): Promise<void> {
		return new Promise((resolve, reject) => {
			let alert = TNSFancyAlert.createAlert(width);
			TNSFancyAlert.applyTextDisplayOptions(alert);
	 ...
	 * Base Method
	 **/
	public static show(type: string, title: string, subTitle?: string, closeBtnTitle?: string, duration?: number, width?: number, buttons?: Array<TNSFancyAlertButton>) {
		let alert = TNSFancyAlert.createAlert(width);
		TNSFancyAlert.applyTextDisplayOptions(alert);
	...
	public static applyOptions(alert: any) {
		...
		if (TNSFancyAlert.customViewColor) alert.customViewColor = new Color(TNSFancyAlert.customViewColor).ios;

		if (TNSFancyAlert.iconTintColor) alert.iconTintColor = new Color(TNSFancyAlert.iconTintColor).ios;

		if (TNSFancyAlert.titleColor) alert.labelTitle.textColor = new Color(TNSFancyAlert.titleColor).ios;

		if (TNSFancyAlert.bodyTextColor) alert.viewText.textColor = new Color(TNSFancyAlert.bodyTextColor).ios;
		...
		if (TNSFancyAlert.backgroundViewColor) alert.backgroundViewColor = new Color(TNSFancyAlert.backgroundViewColor).ios;
