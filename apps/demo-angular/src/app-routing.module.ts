...
const routes: Routes = [
   ...
   { path: 'home', component: HomeComponent },
	...
	{ path: 'nativescript-azure-notificationhubs', loadChildren: () => import('./plugin-demos/nativescript-azure-notificationhubs.module').then(m => m.NativescriptAzureNotificationhubsModule) },
